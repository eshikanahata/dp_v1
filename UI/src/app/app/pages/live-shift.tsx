              ...
              <div className="border-2 border-[#d4a574] rounded-md p-6 bg-gradient-to-br from-[#d4a574]/5 to-transparent">
                <div className="mb-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      <div className="text-base font-medium mb-1">Report Issue</div>
                      <div className="text-xs text-muted-foreground">
                        Flagged events detected this shift
                      </div>
                    </div>
                  </div>
                  
                  <div className="mt-4 space-y-2 bg-white/50 rounded p-3 border border-[#d4a574]/20">
                    <div className="text-xs font-medium text-muted-foreground mb-2">
                      Recent Flags:
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span>Harsh Braking</span>
                      <span className="text-[#d4a574]">14:32:18</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span>Cabin Audio Event</span>
                      <span className="text-[#d4a574]">14:31:45</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span>Sudden Maneuver</span>
                      <span className="text-[#d4a574]">14:30:12</span>
                    </div>
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="w-full bg-[#d4a574] text-white rounded py-3 text-sm font-medium hover:bg-[#d4a574]/90 transition-colors flex items-center justify-center gap-2"
                >
                ...
                <p className="text-xs text-center text-muted-foreground mt-3">
                  Your input helps improve system accuracy
                </p>
              </div>
            </div>
