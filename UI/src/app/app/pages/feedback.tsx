          ...
          <div className="mb-6">
            ...
            <RadioGroup value={fairness} onValueChange={(value) => setFairness(value as 'fair' | 'unfair')}>
              <div className="space-y-3">
                <div className={`flex items-center space-x-3 border rounded p-4 transition-all cursor-pointer ${
                  fairness === 'fair' 
                    ? 'border-[#7ba88a] bg-[#7ba88a]/10 shadow-sm' 
                    : 'border-border hover:bg-muted/30'
                }`}>
                  <RadioGroupItem value="fair" id="fair" />
                  <Label htmlFor="fair" className="text-sm font-normal cursor-pointer flex-1">
                    <div className={`font-medium mb-1 ${fairness === 'fair' ? 'text-[#7ba88a]' : ''}`}>
                      Fair Assessment
                    </div>
                ...
                <div className={`flex items-center space-x-3 border rounded p-4 transition-all cursor-pointer ${
                  ...
                  <Label htmlFor="unfair" className="text-sm font-normal cursor-pointer flex-1">
                    <div className={`font-medium mb-1 ${fairness === 'unfair' ? 'text-[#d4a574]' : ''}`}>
                      Unfair Assessment
                    </div>
                    <div className="text-xs text-muted-foreground">
